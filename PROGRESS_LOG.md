...
- Edited sql05 customer_type and broke this column into 2
  ...
  - Customer_Value_Type: categorizes customers into high-value and standard customers based on if the revenue generated from that customer is within the top 10% of all customers
